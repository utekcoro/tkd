            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Pengiriman Pesanan</li>
                    </ol>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="d-flex justify-content-end mb-3">
                        <a href="{{ route('pengiriman_pesanan.create') }}" class="btn btn-primary">
                        ...
                        <div class="card-body">
                            <table id="pengiriman_pesanan" class="table table-head-fixed text-nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a
                                                href="{{ route('pengiriman_pesanan.detail', $item['number']) }}">{{ $item['number'] ?? 'N/A' }}</a></td>
...
<script>
    ...
    updateTitle('Pengiriman Pesanan');
