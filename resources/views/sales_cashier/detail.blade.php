            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('cashier.index') }}">Kasir</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <th>Dipesan Oleh</th>
                                            <td>{{ $accurateDetail['customer']['contactInfo']['name'] ?? 'N/A' }}</td>
                                        </tr>
                                    </table>
                                </div>
                                <div class="col-md-6">
                                    <table class="table table-bordered">
                                        <tr>
                                            ...
                                            <td>{{ $kasirPenjualan->syarat_bayar ?? 'N/A' }}</td>
                                        </tr>
                                        <tr>
                                            <th>Alamat</th>
                                            <td>{{ $kasirPenjualan->alamat ?? 'N/A' }}</td>
                                        </tr>
                                        <tr>
                                            <th>Info Pajak</th>
                                            <td>
